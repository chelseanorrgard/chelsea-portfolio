...
const Hobbies = () => (
  <div className="max-w-screen-lg mx-auto p-6">
    ...
    <div className="mt-4 text-lg text-gray-700 leading-relaxed">
      ...
      <h2 className="text-3xl font-semibold text-pink-400 mt-6">Baking and Cooking</h2>
      <p className="mt-2">
      ...
      <h2 className="text-3xl font-semibold text-pink-400 mt-6">Knitting and Crochet</h2>
      <p className="mt-2">
      ...
      <img src={Yarn} alt="Yarn Wall" className="w-1/2 h-auto rounded-lg shadow-md mt-4" />
      </div>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-4">
